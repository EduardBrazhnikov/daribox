...
<div class="sweets"><div class="circleSweets" style="border: 10px solid #800000; background-color: #FF0000;"><img src="/views/image/sweets.png"/></div><p class="circleText2">СЛАДОСТИ</p>
...
<div class="product">
  <div class="vkl1"><span class="css-tag"><span class="css-tag1"><?=$sweets[0]['price'];?></span> грн</span><img class="picture" src="/views/image/sweets.png"/><p class="textBox"><span class="textBox1"><?=$sweets[0]['name'];?></span></p><p class="order1">ЗАКАЗАТЬ</p><div class="triangle-down1"></div></div>
  <div class="vkl2"><span class="css-tag"><span class="css-tag2"><?=$sweets[1]['price'];?></span> грн</span><img class="picture" src="/views/image/sweets.png"/><p class="textBox"><span class="textBox2"><?=$sweets[1]['name'];?></span></p><p class="order2">ЗАКАЗАТЬ</p><div class="triangle-down2"></div></div>
  <div class="vkl3"><span class="css-tag"><span class="css-tag3"><?=$sweets[2]['price'];?></span> грн</span><img class="picture" src="/views/image/sweets.png"/><p class="textBox"><span class="textBox3"><?=$sweets[2]['name'];?></span></p><p class="order3">ЗАКАЗАТЬ</p><div class="triangle-down3"></div></div>
  <div class="vkl4"><span class="css-tag"><span class="css-tag4"><?=$sweets[3]['price'];?></span> грн</span><img class="picture" src="/views/image/sweets.png"/><p class="textBox"><span class="textBox4"><?=$sweets[3]['name'];?></span></p><p class="order4">ЗАКАЗАТЬ</p><div class="triangle-down4"></div></div>
</div>
<div class="contentBox">
<div class="box1">
<div class="imgBox">
<img class="onePicture" src="/views/image/sweets.png"/>
</div>
<div class="nameBox"><h1 id="nameBox"><?=$sweets[0]['name'];?></h1><p id="price"><span id="cost"><?=$sweets[0]['price'];?></span> грн</p>
