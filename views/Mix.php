...
<div class="mix"><div class="circleMix" style="border: 10px solid #FF8C00; background-color: #FFFF00;"><img src="/views/image/mix.png"/></div><p class="circleText3">МИКС</p>
...
<div class="product">
  <div class="vkl1"><span class="css-tag"><span class="css-tag1"><?=$mix[0]['price'];?></span> грн</span><img class="picture" src="/views/image/mix.png"/><p class="textBox"><span class="textBox1"><?=$mix[0]['name'];?></span></p><p class="order1">ЗАКАЗАТЬ</p><div class="triangle-down1"></div></div>
  <div class="vkl2"><span class="css-tag"><span class="css-tag2"><?=$mix[1]['price'];?></span> грн</span><img class="picture" src="/views/image/mix.png"/><p class="textBox"><span class="textBox2"><?=$mix[1]['name'];?></span></p><p class="order2">ЗАКАЗАТЬ</p><div class="triangle-down2"></div></div>
  <div class="vkl3"><span class="css-tag"><span class="css-tag3"><?=$mix[2]['price'];?></span> грн</span><img class="picture" src="/views/image/mix.png"/><p class="textBox"><span class="textBox3"><?=$mix[2]['name'];?></span></p><p class="order3">ЗАКАЗАТЬ</p><div class="triangle-down3"></div></div>
  <div class="vkl4"><span class="css-tag"><span class="css-tag4"><?=$mix[3]['price'];?></span> грн</span><img class="picture" src="/views/image/mix.png"/><p class="textBox"><span class="textBox4"><?=$mix[3]['name'];?></span></p><p class="order4">ЗАКАЗАТЬ</p><div class="triangle-down4"></div></div>
</div>
<div class="contentBox">
<div class="box1">
<div class="imgBox">
<img class="onePicture" src="/views/image/mix.png"/>
</div>
<div class="nameBox"><h1 id="nameBox"><?=$mix[0]['name'];?></h1><p id="price"><span id="cost"><?=$mix[0]['price'];?></span> грн</p>
