<div id="overlay18"><div class="popup18"><h3 style="margin-bottom: 1em;">Внимание! Эта страница только для тех кому исполнилось 18 лет</h3>
<div class="window18">
<div class="comeBack">Вернуться на главную</div>
<div class="popup__close18">Продолжить просмотр</div>
</div></div></div>
<h2 class="titleBlock">ВЫБЕРИТЕ ТИП ПОДАРКА</h2>
<div class="circleNav">
<div class="present"><div class="circlePresent"><img src="/views/image/box_sm.png"/></div><p class="circleText1">ПОДАРКИ</p>
...
<div class="intim"><div class="circleIntim" style="border: 10px solid #C71585; background-color: #FF69B4;"><img src="/views/image/Darintim.png"/></div><p class="circleText4">ИНТИМ</p>
...
<div class="product">
  <div class="vkl1"><span class="css-tag"><span class="css-tag1"><?=$intim[0]['price'];?></span> грн</span><img class="picture" src="/views/image/Darintim.png"/><p class="textBox"><span class="textBox1"><?=$intim[0]['name'];?></span></p><p class="order1">ЗАКАЗАТЬ</p><div class="triangle-down1"></div></div>
  <div class="vkl2"><span class="css-tag"><span class="css-tag2"><?=$intim[1]['price'];?></span> грн</span><img class="picture" src="/views/image/Darintim.png"/><p class="textBox"><span class="textBox2"><?=$intim[1]['name'];?></span></p><p class="order2">ЗАКАЗАТЬ</p><div class="triangle-down2"></div></div>
  <div class="vkl3"><span class="css-tag"><span class="css-tag3"><?=$intim[2]['price'];?></span> грн</span><img class="picture" src="/views/image/Darintim.png"/><p class="textBox"><span class="textBox3"><?=$intim[2]['name'];?></span></p><p class="order3">ЗАКАЗАТЬ</p><div class="triangle-down3"></div></div>
  <div class="vkl4"><span class="css-tag"><span class="css-tag4"><?=$intim[3]['price'];?></span> грн</span><img class="picture" src="/views/image/Darintim.png"/><p class="textBox"><span class="textBox4"><?=$intim[3]['name'];?></span></p><p class="order4">ЗАКАЗАТЬ</p><div class="triangle-down4"></div></div>
</div>
<div class="contentBox">
<div class="box1">
<div class="imgBox">
<img class="onePicture" alt="intimBox" src="/views/image/Darintim.png"/>
</div>
<div class="nameBox"><h1 id="nameBox"><?=$intim[0]['name'];?></h1><p id="price"><span id="cost"><?=$intim[0]['price'];?></span> грн</p>
