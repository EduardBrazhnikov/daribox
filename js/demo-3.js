(function() {
    ...
    function Triangle() {
        ...
        function init() {
            ...
            _this.coords[0].y = -10+Math.random()*20;
            _this.coords[1].x = -10+Math.random()*20;
            _this.coords[1].y = -10+Math.random()*20;
            _this.coords[2].x = -10+Math.random()*20;
            _this.coords[2].y = -10+Math.random()*20;
